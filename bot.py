...
async def admin_button(
    ...
    if q.data == "a:products":
        ...
        ctx.user_data["admin_mode"] = "photo"
...
async def admin_photo(
    ...
    if ctx.user_data.get("admin_mode") != "photo":
        return
    ...
    ctx.user_data["photo_id"] = photo_id
...
async def admin_text(
    ...
    # 添加商品时跳过图片
    if mode == "photo" and update.message.text.strip() == "跳过":

        ctx.user_data["photo_id"] = ""
        ctx.user_data["admin_mode"] = "add"
